...
class CredentialManager:
    """
    Manage test credentials with local file storage and reusability.

    Stores credentials as plaintext JSON in a gitignored .credentials file
    (chmod 600 on Unix) for reuse across testing sessions. Intended for
    disposable test accounts only — do not store production credentials.
    """
