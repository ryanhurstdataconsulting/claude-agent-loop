...
EXPECTED_HOOKS="inject-resource-loop.sh harvest-metrics.sh precompact-event.sh auto-update.sh context-budget.sh usage-budget.sh read-guard.sh pipeline-relay.sh loop-close.sh obs-events.sh"
